...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        @foreach($flight_data['flight_home'] as $id => $flight)
            <h2>
                <i class="fa fa-arrow-left"></i>{{ trans('mamorunl-ota::flight.display.flight_information') }} {{ $flight['airline_code'] }} {{ $flight['flight_number'] }}
                : {{ $flight['date_departure'] }}</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    &euro; {{ number_format($row_letter_b['price'], 2, ",", ".") }}
                </div>
            </div>
        @endforeach
    </div>
    ...
    {{--<div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                &euro; {{ number_format($flight['price'], 2, ",", ".") }}
            </div>
        </div>
    </div>--}}
</div>
